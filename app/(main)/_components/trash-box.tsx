...
export const TrashBox = () => {
   ...
   *
   * @param event - The mouse event that triggered the restore action.
  ...
  /**
   * Removes a document from the trash.
   *
   * @param documentId - The ID of the document to remove.
   */
  const onRemove = (documentId: Id<"documents">) => {
    const promise = remove({ id: documentId }); // remove the document from the trash
  ...
  return (
    <div className="text-sm">
      ...
      <div className="mt-2 px-1 pb-1">
        {/* SHOW THE MESSAGE IF THERE ARE NO DOCUMENTS IN THE TRASH */}
